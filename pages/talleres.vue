...
<main id="app" class="content">
  <nav class="nav">
    <menu class="nav__controls">
      ...
      <li
        class="nav__label nav__label--clear" @click="clearAllFilters">Clear all
      </li>
    </menu>

    <label class="nav__label"
    @click="modal = !modal">About this pen</label>
  </nav>

  <transition-group
    name="dropdown" tag="section" class="dropdown" :style="dropdown"
  >
    <menu
  ...
  <transition-group
    name="company" tag="ul" class="content__list"
  >
    <li class="company"
    v-for="company in list" :key="company.id">
...
.nav {
  ...
  border-bottom: 1px solid #07c5d6d5;
}
.nav__controls {
  display: -webkit-box;
  display: flex;
