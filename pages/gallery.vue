...
<style>
  ...
  .gallery-display .postcard-transition {
    z-index: 1;
    transition: all 0.2s;
  }
  ...
  .postcard {
    ...
    box-shadow: 
    0 2.8px 2.2px rgba(28, 164, 243, 0.034), 0 6.7px 5.3px rgba(0, 0, 0, 0.048), 0 12.5px 10px rgba(0, 0, 0, 0.06), 0 2.3px 70.9px rgba(0, 0, 0, 0.072), 0 6.8px 15.4px rgba(0, 0, 0, 0.01);
    overflow: hidden;
    margin: auto;
    transition: all 0.6s;
    position: relative;
  ...
  .postcard__front {
    background-color: rgba(18, 125, 247, 0.2);
    padding-top: 20px;
    height: 100%;
    width: 100%;
  }
  ...
  body {
    ...
    max-width: 1200px;
    margin: auto;
    background-color: rgba(87, 160, 224, 0.3);
  }
</style>